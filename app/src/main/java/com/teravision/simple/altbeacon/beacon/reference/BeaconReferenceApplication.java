...
import com.teravision.simple.activities.home.HomeActivity;
...
public class BeaconReferenceApplication extends Application implements BootstrapNotifier {
    ...
    public void onCreate() {
        ...
        beaconManager.setBackgroundBetweenScanPeriod(360000l);
    ...
    public void didEnterRegion(Region arg0) {
        ...
        if (!haveDetectedBeaconsSinceBoot) {
            ...
            intent.putExtra("isBackground", Boolean.TRUE);
    ...
    public void didExitRegion(Region region) {
        if (rangingActivity != null) {
            rangingActivity.logToDisplay("I no longer see a beacon.");
        }
    }
